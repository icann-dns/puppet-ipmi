  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      describe 'Change Defaults' do
        context 'ip' do
          before { params.merge!(type: 'static', ip: '192.0.2.42') }
        ...
        context 'netmask' do
          before { params.merge!(type: 'static', netmask: '255.255.255.192') }
          it { is_expected.to compile }
          it do
        ...
        context 'gateway' do
          before { params.merge!(type: 'static', gateway: '192.0.2.254') }
          it { is_expected.to compile }
          it do
        ...
        context 'lan_channel' do
          before { params.merge!(type: 'static', lan_channel: 42) }
          it { is_expected.to compile }
          it do
